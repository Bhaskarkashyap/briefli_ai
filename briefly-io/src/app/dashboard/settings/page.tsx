...
function SettingsContent() {
  ...
  return (
    <div>
      ...
      {showUpgrade && !isPro && (
        <div className="card p-6 mb-6 border-[var(--accent-primary)]">
          <h2
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <div className="card p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="px-4 py-3 rounded-lg bg-[var(--bg-tertiary)]">
        ...
        <div className="card p-6">
          ...
          <div className="flex items-center justify-between p-4 rounded-lg bg-[var(--bg-tertiary)] mb-4">
            <div>
